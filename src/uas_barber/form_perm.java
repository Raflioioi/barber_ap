 ...
 * @author ASUS
 */
public class form_perm extends javax.swing.JFrame {
    ...
    private void addData() throws SQLException {
        try {
            String sql = "INSERT INTO `order` (`nama`, `email`, `no_hp`, `jam`, `hari`, "
                    ...
                    + "'" + hpField.getText().toString() + "','" + jComboBox1.getSelectedItem().toString() + "',"
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "JAM 10.00", "JAM 10.30", "JAM 11.00", "JAM 12.00", "JAM 13.00", "JAM 13.30", "JAM 14.00", "JAM 14.30", "JAM 15.00", "JAM 15.30", "JAM 16.00", "JAM 16.30", "JAM 17.00", "JAM 17.30", "JAM 18.00", "JAM 18.30", "JAM 19.00", "JAM 19.30", "JAM 20.00", "JAM 20.30", "JAM 21.00" }));
        jComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox1ActionPerformed(evt);
            }
        });
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 210, 100, -1));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SENIN", "SELASA", "RABU", "KAMIS", "JUMAT", "SABTU", " " }));
        jPanel1.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 100, -1));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BOY - PRICELIST  Rp 50.000", "BEN - PRICELIST  Rp 75.000", "JAYA - PRICELIST  Rp 100.000" }));
        jPanel1.add(jComboBox3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 290, 220, -1));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PERMING NORMAL", "PERMING EXPERT" }));
        jPanel1.add(jComboBox4, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 330, 220, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        halaman_perm2 hall = new halaman_perm2();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_perm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
