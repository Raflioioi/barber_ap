 ...
 * @author ASUS
 */
public class form_haircut extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        boxLayanan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "LURUS", "KERITING", "GELOMBANG", "KRIBO", " " }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_haircut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_haircut().setVisible(true);
            }
        });
    }
